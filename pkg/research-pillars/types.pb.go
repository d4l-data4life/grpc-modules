...
type TopicScope int32

const (
	TopicScope_session TopicScope = 0 // current fill session only
	TopicScope_latest  TopicScope = 1 // + the latest persisted response
	TopicScope_all     TopicScope = 2 // + all persisted responses
)

// Enum value maps for TopicScope.
var (
	TopicScope_name = map[int32]string{
		0: "session",
		1: "latest",
		2: "all",
	}
	TopicScope_value = map[string]int32{
		"session": 0,
		"latest":  1,
		"all":     2,
	}
...
func (x TopicScope) Enum() *TopicScope {
	p := new(TopicScope)
	*p = x
	return p
}

func (x TopicScope) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (TopicScope) Descriptor() protoreflect.EnumDescriptor {
	return file_research_pillars_types_proto_enumTypes[0].Descriptor()
}

func (TopicScope) Type() protoreflect.EnumType {
	return &file_research_pillars_types_proto_enumTypes[0]
}

func (x TopicScope) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use TopicScope.Descriptor instead.
func (TopicScope) EnumDescriptor() ([]byte, []int) {
...
func (CodeStatus) Descriptor() protoreflect.EnumDescriptor {
	return file_research_pillars_types_proto_enumTypes[4].Descriptor()
}

func (CodeStatus) Type() protoreflect.EnumType {
	return &file_research_pillars_types_proto_enumTypes[4]
}
...
func (x *Question) GetImage() *QuestionImage {
	if x != nil {
		return x.Image
	}
	return nil
...
func (x *Question) GetInput() []*TopicInput {
	if x != nil {
		return x.Input
	}
	return nil
...
func (x *Question) GetOutput() []string {
	if x != nil {
		return x.Output
	}
	return nil
...
type TopicInput struct {
	...
	Scope         TopicScope             `protobuf:"varint,2,opt,name=scope,proto3,enum=proto.TopicScope" json:"scope,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *TopicInput) GetScope() TopicScope {
	if x != nil {
		return x.Scope
	}
...
func (x *QuestionImage) GetContentType() string {
	if x != nil {
...
func (x *QuestionImage) GetSrc() string {
	if x != nil {
		return x.Src
	}
	return ""
...
type DeviceToken struct {
	...
	ParticipantCode *string                `protobuf:"bytes,4,opt,name=participantCode,proto3,oneof" json:"participantCode,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
func (x *DeviceToken) GetSubjectID() string {
	if x != nil {
		return x.SubjectID
	}
	return ""
...
func (x *DeviceToken) GetParticipantCode() string {
...
const file_research_pillars_types_proto_rawDesc = "" +
	"\n" +
	"\x1cresearch-pillars/types.proto\x12\x05proto\x1a\x1cgoogle/protobuf/struct.proto\"\xdd\x01\n" +
	"\rQuestionnaire\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x18\n" +
	"\aversion\x18\x02 \x01(\tR\aversion\x125\n" +
	"\x05title\x18\x03 \x03(\v2\x1f.proto.Questionnaire.TitleEntryR\x05title\x12-\n" +
	"\tquestions\x18\x04 \x03(\v2\x0f.proto.QuestionR\tquestions\x1a8\n" +
	"\n" +
	"TitleEntry\x12\x10\n" +
	...
	"\x04text\x18\x04 \x03(\v2\x19.proto.Question.TextEntryR\x04text\x123\n" +
	"\tanswerset\x18\x05 \x01(\v2\x10.proto.AnswersetH\x00R\tanswerset\x88\x01\x01\x124\n" +
	...
	"\x05scope\x18\x02 \x01(\x0e2\x11.proto.TopicScopeR\x05scope\"r\n" +
	"\tAnswerset\x12\x14\n" +
	...
	"\boperator\x18\x02 \x01(\x0e2\x0f.proto.OperatorR\boperator\x12(\n" +
	"\ranswer_coding\x18\x03 \x01(\tH\x00R\fanswerCoding\x88\x01\x01\x12*\n" +
	"\x0eanswer_decimal\x18\x04 \x01(\x01H\x01R\ranswerDecimal\x88\x01\x01\x12$\n" +
	"\vanswer_date\x18\x05 \x01(\tH\x02R\n" +
	...
	"\x03alt\x18\x04 \x01(\tR\x03alt\"v\n" +
	"\x04Diff\x12/\n" +
	"\x06change\x18\x01 \x01(\v2\x17.google.protobuf.StructR\x06change\x12\x1c\n" +
	"\ttimestamp\x18\x02 \x01(\tR\ttimestamp\x12\x1f\n" +
	"\x04user\x18\x03 \x01(\v2\v.proto.UserR\x04user\"\x82\x01\n" +
	"\x04User\x12\x14\n" +
	"\x05email\x18\x01 \x01(\tR\x05email\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12\x18\n" +
	"\aisAdmin\x18\x03 \x01(\bR\aisAdmin\x126\n" +
	"\fprogramRoles\x18\x04 \x03(\v2\x12.proto.ProgramRoleR\fprogramRoles\"n\n" +
	"\vProgramRole\x12\x1c\n" +
	"\tuserEmail\x18\x01 \x01(\tR\tuserEmail\x12 \n" +
	"\vprogramName\x18\x02 \x01(\tR\vprogramName\x12\x1f\n" +
	"\x04role\x18\x03 \x01(\x0e2\v.proto.RoleR\x04role\"n\n" +
	"\x0eBlockedProgram\x12\x1c\n" +
	"\tuserEmail\x18\x01 \x01(\tR\tuserEmail\x12 \n" +
	"\vprogramName\x18\x02 \x01(\tR\vprogramName\x12\x1c\n" +
	...
	"\n" +
	"\x06latest\x10\x01\x12\a\n" +
	"\x03all\x10\x02*\x9b\x02\n" +
	"\tInputType\x12\v\n" +
	...
	"\adecimal\x10\x04\x12\b\n" +
	"\x04date\x10\x05\x12\x11\n" +
	"\rsingle_select\x10\x06\x12\x10\n" +
	"\fmulti_select\x10\a\x12\b\n" +
