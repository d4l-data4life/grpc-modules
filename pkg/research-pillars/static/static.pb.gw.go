...
var filter_Programs_GetProgramData_0 = &utilities.DoubleArray{Encoding: map[string]int{"name": 0}, Base: []int{1, 1, 0}, Check: []int{0, 1, 2}}
...
func request_Programs_GetProgramData_0(ctx context.Context, marshaler runtime.Marshaler, client ProgramsClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_Programs_GetProgramData_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
	if req.Body != nil {
		_, _ = io.Copy(io.Discard, req.Body)
...
var filter_FHIR_GetQuestionnaire_0 = &utilities.DoubleArray{Encoding: map[string]int{"programName": 0, "name": 1}, Base: []int{1, 1, 2, 0, 0}, Check: []int{0, 1, 1, 2, 3}}

func request_FHIR_GetQuestionnaire_0(ctx context.Context, marshaler runtime.Marshaler, client FHIRClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var (
		protoReq GetFHIRQuestionnaireRequest
		metadata runtime.ServerMetadata
		err      error
	)
	val, ok := pathParams["programName"]
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_FHIR_GetQuestionnaire_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
	if req.Body != nil {
		_, _ = io.Copy(io.Discard, req.Body)
...
func local_request_FHIR_GetQuestionnaire_0(ctx context.Context, marshaler runtime.Marshaler, server FHIRServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var (
		protoReq GetFHIRQuestionnaireRequest
		metadata runtime.ServerMetadata
		err      error
...
var filter_FHIR_GetStandaloneQuestionnaire_0 = &utilities.DoubleArray{Encoding: map[string]int{"name": 0}, Base: []int{1, 1, 0}, Check: []int{0, 1, 2}}

func request_FHIR_GetStandaloneQuestionnaire_0(ctx context.Context, marshaler runtime.Marshaler, client FHIRClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var (
		protoReq GetStandaloneFHIRQuestionnaireRequest
		metadata runtime.ServerMetadata
		err      error
	)
	val, ok := pathParams["name"]
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_FHIR_GetStandaloneQuestionnaire_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
	if req.Body != nil {
		_, _ = io.Copy(io.Discard, req.Body)
...
func local_request_FHIR_GetStandaloneQuestionnaire_0(ctx context.Context, marshaler runtime.Marshaler, server FHIRServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var (
		protoReq GetStandaloneFHIRQuestionnaireRequest
		metadata runtime.ServerMetadata
		err      error
...
// RegisterFHIRHandlerServer registers the http handlers for service FHIR to "mux".
// UnaryRPC     :call FHIRServer directly.
// StreamingRPC :currently unsupported pending https://github.com/grpc/grpc-go/issues/906.
// Note that using this registration option will cause many gRPC library features to stop working. Consider using RegisterFHIRHandlerFromEndpoint instead.
// GRPC interceptors will not work for this type of registration. To use interceptors, you must use the "runtime.WithMiddlewares" option in the "runtime.NewServeMux" call.
func RegisterFHIRHandlerServer(ctx context.Context, mux *runtime.ServeMux, server FHIRServer) error {
	mux.Handle(http.MethodGet, pattern_FHIR_GetQuestionnaire_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/proto.static.FHIR/GetQuestionnaire", runtime.WithHTTPPathPattern("/r5/{programName}/Questionnaire/{name}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_FHIR_GetQuestionnaire_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_FHIR_GetQuestionnaire_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
	})
	mux.Handle(http.MethodGet, pattern_FHIR_GetStandaloneQuestionnaire_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/proto.static.FHIR/GetStandaloneQuestionnaire", runtime.WithHTTPPathPattern("/r5/Questionnaire/{name}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_FHIR_GetStandaloneQuestionnaire_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_FHIR_GetStandaloneQuestionnaire_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
	})
...
// RegisterFHIRHandlerFromEndpoint is same as RegisterFHIRHandler but
// automatically dials to "endpoint" and closes the connection when "ctx" gets done.
func RegisterFHIRHandlerFromEndpoint(ctx context.Context, mux *runtime.ServeMux, endpoint string, opts []grpc.DialOption) (err error) {
	conn, err := grpc.NewClient(endpoint, opts...)
	if err != nil {
		return err
	}
	...
	return RegisterFHIRHandler(ctx, mux, conn)
}

// RegisterFHIRHandler registers the http handlers for service FHIR to "mux".
// The handlers forward requests to the grpc endpoint over "conn".
func RegisterFHIRHandler(ctx context.Context, mux *runtime.ServeMux, conn *grpc.ClientConn) error {
	return RegisterFHIRHandlerClient(ctx, mux, NewFHIRClient(conn))
}

// RegisterFHIRHandlerClient registers the http handlers for service FHIR
// to "mux". The handlers forward requests to the grpc endpoint over the given implementation of "FHIRClient".
// Note: the gRPC framework executes interceptors within the gRPC handler. If the passed in "FHIRClient"
// doesn't go through the normal gRPC flow (creating a gRPC client etc.) then it will be up to the passed in
// "FHIRClient" to call the correct interceptors. This client ignores the HTTP middlewares.
func RegisterFHIRHandlerClient(ctx context.Context, mux *runtime.ServeMux, client FHIRClient) error {
	mux.Handle(http.MethodGet, pattern_FHIR_GetQuestionnaire_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateContext(ctx, mux, req, "/proto.static.FHIR/GetQuestionnaire", runtime.WithHTTPPathPattern("/r5/{programName}/Questionnaire/{name}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_FHIR_GetQuestionnaire_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle(http.MethodGet, pattern_FHIR_GetStandaloneQuestionnaire_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateContext(ctx, mux, req, "/proto.static.FHIR/GetStandaloneQuestionnaire", runtime.WithHTTPPathPattern("/r5/Questionnaire/{name}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_FHIR_GetStandaloneQuestionnaire_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_FHIR_GetQuestionnaire_0           = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 1, 0, 4, 1, 5, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"r5", "programName", "Questionnaire", "name"}, ""))
	pattern_FHIR_GetStandaloneQuestionnaire_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2}, []string{"r5", "Questionnaire", "name"}, ""))
)

var (
	forward_FHIR_GetQuestionnaire_0           = runtime.ForwardResponseMessage
	forward_FHIR_GetStandaloneQuestionnaire_0 = runtime.ForwardResponseMessage
)
