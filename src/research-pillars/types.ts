...
export enum TopicScope {
  /** session - current fill session only */
  session = 0,
  /** latest - + the latest persisted response */
  latest = 1,
  /** all - + all persisted responses */
  all = 2,
  UNRECOGNIZED = -1,
}

export function topicScopeFromJSON(object: any): TopicScope {
  switch (object) {
    case 0:
    case "session":
      return TopicScope.session;
    case 1:
    case "latest":
      return TopicScope.latest;
    case 2:
    case "all":
      return TopicScope.all;
    case -1:
    case "UNRECOGNIZED":
    default:
      return TopicScope.UNRECOGNIZED;
  }
}

export function topicScopeToJSON(object: TopicScope): string {
  switch (object) {
    case TopicScope.session:
      return "session";
    case TopicScope.latest:
      return "latest";
    case TopicScope.all:
      return "all";
    case TopicScope.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}
...
export interface Question {
  ...
  image?:
    | QuestionImage
    | undefined;
  /** populate this question's candidate options from topics */
  input: TopicInput[];
...
export const Questionnaire: MessageFns<Questionnaire> = {
  encode(message: Questionnaire, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    globalThis.Object.entries(message.title).forEach(([key, value]: [string, string]) => {
  ...
  fromJSON(object: any): Questionnaire {
    return {
      ...
      title: isObject(object.title)
        ? (globalThis.Object.entries(object.title) as [string, any][]).reduce(
  ...
  toJSON(message: Questionnaire): unknown {
    ...
    if (message.title) {
      const entries = globalThis.Object.entries(message.title) as [string, string][];
      if (entries.length > 0) {
        obj.title = {};
        entries.forEach(([k, v]) => {
          obj.title[k] = v;
  ...
  fromPartial<I extends Exact<DeepPartial<Questionnaire>, I>>(object: I): Questionnaire {
    ...
    message.title = (globalThis.Object.entries(object.title ?? {}) as [string, string][]).reduce(
...
export const Question: MessageFns<Question> = {
  encode(message: Question, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    globalThis.Object.entries(message.text).forEach(([key, value]: [string, string]) => {
    ...
    for (const v of message.input) {
      TopicInput.encode(v!, writer.uint32(98).fork()).join();
    }
      ...
      while (reader.pos < end) {
        ...
        switch (tag >>> 3) {
          ...
          case 12: {
            ...
            message.input.push(TopicInput.decode(reader, reader.uint32()));
            continue;
          }
          case 13: {
            if (tag !== 106) {
  ...
  fromJSON(object: any): Question {
    return {
      ...
      text: isObject(object.text)
        ? (globalThis.Object.entries(object.text) as [string, any][]).reduce(
          (acc: { [key: string]: string }, [key, value]: [string, any]) => {
            globalThis.Object.defineProperty(acc, key, {
              value: globalThis.String(value),
              enumerable: true,
      ...
      enableWhen: globalThis.Array.isArray(object?.enableWhen)
        ...
        : globalThis.Array.isArray(object?.enable_when)
        ? object.enable_when.map((e: any) => EnableWhen.fromJSON(e))
        : [],
      enableBehavior: isSet(object.enableBehavior)
        ? globalThis.String(object.enableBehavior)
        : isSet(object.enable_behavior)
        ? globalThis.String(object.enable_behavior)
        : undefined,
  ...
  toJSON(message: Question): unknown {
    ...
    if (message.text) {
      const entries = globalThis.Object.entries(message.text) as [string, string][];
      if (entries.length > 0) {
        obj.text = {};
        entries.forEach(([k, v]) => {
          obj.text[k] = v;
    ...
    if (message.input?.length) {
      obj.input = message.input.map((e) => TopicInput.toJSON(e));
    }
  ...
  fromPartial<I extends Exact<DeepPartial<Question>, I>>(object: I): Question {
    ...
    message.text = (globalThis.Object.entries(object.text ?? {}) as [string, string][]).reduce(
      (acc: { [key: string]: string }, [key, value]: [string, string]) => {
        if (value !== undefined) {
          acc[key] = globalThis.String(value);
        }
...
function createBaseTopicInput(): TopicInput {
  return { topic: "", scope: 0 };
}

export const TopicInput: MessageFns<TopicInput> = {
  encode(message: TopicInput, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.topic !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): TopicInput {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const previousRecursionDepth = (reader as any).__tsProtoDecodeDepth ?? 0;
    if (previousRecursionDepth >= 100) {
      throw new globalThis.Error("protobuf decode recursion limit exceeded");
    ...
    try {
      const end = length === undefined ? reader.len : reader.pos + length;
      const message = createBaseTopicInput();
      while (reader.pos < end) {
        const tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
  ...
  fromJSON(object: any): TopicInput {
    return {
      topic: isSet(object.topic) ? globalThis.String(object.topic) : "",
      scope: isSet(object.scope) ? topicScopeFromJSON(object.scope) : 0,
    };
  },

  toJSON(message: TopicInput): unknown {
    const obj: any = {};
    if (message.topic !== "") {
  ...
  create<I extends Exact<DeepPartial<TopicInput>, I>>(base?: I): TopicInput {
    return TopicInput.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<TopicInput>, I>>(object: I): TopicInput {
    const message = createBaseTopicInput();
...
export const Answer: MessageFns<Answer> = {
  encode(message: Answer, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    globalThis.Object.entries(message.languages).forEach(([key, value]: [string, string]) => {
  ...
  toJSON(message: Answer): unknown {
    ...
    if (message.languages) {
      const entries = globalThis.Object.entries(message.languages) as [string, string][];
      if (entries.length > 0) {
        obj.languages = {};
        entries.forEach(([k, v]) => {
          obj.languages[k] = v;
  ...
  fromPartial<I extends Exact<DeepPartial<Answer>, I>>(object: I): Answer {
    ...
    message.languages = (globalThis.Object.entries(object.languages ?? {}) as [string, string][]).reduce(
      (acc: { [key: string]: string }, [key, value]: [string, string]) => {
        if (value !== undefined) {
          acc[key] = globalThis.String(value);
        }
...
export const EnableWhen: MessageFns<EnableWhen> = {
  ...
  fromJSON(object: any): EnableWhen {
    return {
      ...
      answerCoding: isSet(object.answerCoding)
        ? globalThis.String(object.answerCoding)
        : isSet(object.answer_coding)
        ? globalThis.String(object.answer_coding)
        : undefined,
      answerDecimal: isSet(object.answerDecimal)
        ? globalThis.Number(object.answerDecimal)
        : isSet(object.answer_decimal)
        ? globalThis.Number(object.answer_decimal)
        : undefined,
      answerDate: isSet(object.answerDate)
        ? globalThis.String(object.answerDate)
        : isSet(object.answer_date)
        ? globalThis.String(object.answer_date)
        : undefined,
    };
  },
...
function createBaseAccessToken(): AccessToken {
  return { programName: "", name: "", createdAt: "", lastUsedAt: "" };
}
