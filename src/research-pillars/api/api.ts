...
export interface GetNotificationResponse {
  notification?: { [key: string]: any } | undefined;
  recipients: { [key: string]: any }[];
}
...
export const GenerateCodeRequest: MessageFns<GenerateCodeRequest> = {
  encode(message: GenerateCodeRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.programName !== "") {
      writer.uint32(10).string(message.programName);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GenerateCodeRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
  ...
  create<I extends Exact<DeepPartial<GenerateCodeRequest>, I>>(base?: I): GenerateCodeRequest {
    return GenerateCodeRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<GenerateCodeRequest>, I>>(object: I): GenerateCodeRequest {
    const message = createBaseGenerateCodeRequest();
    message.programName = object.programName ?? "";
    return message;
  },
...
export const GenerateCodeResponse: MessageFns<GenerateCodeResponse> = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GenerateCodeResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const GetNotificationsResponse: MessageFns<GetNotificationsResponse> = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1: {
          ...
          message.notifications.push(Struct.unwrap(Struct.decode(reader, reader.uint32())));
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): GetNotificationsResponse {
    return { notifications: globalThis.Array.isArray(object?.notifications) ? [...object.notifications] : [] };
  },
...
function createBaseGetNotificationResponse(): GetNotificationResponse {
  return { notification: undefined, recipients: [] };
}
...
export const GetNotificationResponse: MessageFns<GetNotificationResponse> = {
  encode(message: GetNotificationResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.notification !== undefined) {
      Struct.encode(Struct.wrap(message.notification), writer.uint32(10).fork()).join();
    }
    for (const v of message.recipients) {
      Struct.encode(Struct.wrap(v!), writer.uint32(18).fork()).join();
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1: {
          ...
          message.notification = Struct.unwrap(Struct.decode(reader, reader.uint32()));
          continue;
        }
        case 2: {
          if (tag !== 18) {
  ...
  fromJSON(object: any): GetNotificationResponse {
    return {
      notification: isObject(object.notification) ? object.notification : undefined,
      recipients: globalThis.Array.isArray(object?.recipients) ? [...object.recipients] : [],
    };
  },
...
function createBaseUpsertNotificationRequest(): UpsertNotificationRequest {
  return { programName: "", notification: undefined };
}

export const UpsertNotificationRequest: MessageFns<UpsertNotificationRequest> = {
  encode(message: UpsertNotificationRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.programName !== "") {
      writer.uint32(10).string(message.programName);
    }
    if (message.notification !== undefined) {
      Struct.encode(Struct.wrap(message.notification), writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): UpsertNotificationRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseUpsertNotificationRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): UpsertNotificationRequest {
    return {
      programName: isSet(object.programName) ? globalThis.String(object.programName) : "",
      notification: isObject(object.notification) ? object.notification : undefined,
    };
  ...
  toJSON(message: UpsertNotificationRequest): unknown {
    const obj: any = {};
    if (message.programName !== "") {
      obj.programName = message.programName;
    }
  ...
  create<I extends Exact<DeepPartial<UpsertNotificationRequest>, I>>(base?: I): UpsertNotificationRequest {
    return UpsertNotificationRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<UpsertNotificationRequest>, I>>(object: I): UpsertNotificationRequest {
    const message = createBaseUpsertNotificationRequest();
    message.programName = object.programName ?? "";
    message.notification = object.notification ?? undefined;
    return message;
...
function createBaseUpsertNotificationResponse(): UpsertNotificationResponse {
  return {};
}

export const UpsertNotificationResponse: MessageFns<UpsertNotificationResponse> = {
  encode(_: UpsertNotificationResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): UpsertNotificationResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseUpsertNotificationResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
      }
  ...
  fromJSON(_: any): UpsertNotificationResponse {
    return {};
  },

  toJSON(_: UpsertNotificationResponse): unknown {
    const obj: any = {};
    return obj;
  },

  create<I extends Exact<DeepPartial<UpsertNotificationResponse>, I>>(base?: I): UpsertNotificationResponse {
    return UpsertNotificationResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<UpsertNotificationResponse>, I>>(_: I): UpsertNotificationResponse {
    const message = createBaseUpsertNotificationResponse();
    return message;
  },
};
...
export const DeleteNotificationResponse: MessageFns<DeleteNotificationResponse> = {
  encode(_: DeleteNotificationResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },
  ...
  fromJSON(_: any): DeleteNotificationResponse {
    return {};
  },

  toJSON(_: DeleteNotificationResponse): unknown {
    const obj: any = {};
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<DeleteNotificationResponse>, I>>(_: I): DeleteNotificationResponse {
    const message = createBaseDeleteNotificationResponse();
    return message;
  },
};
...
export const SendNotificationResponse: MessageFns<SendNotificationResponse> = {
  ...
  fromJSON(_: any): SendNotificationResponse {
    return {};
  },

  toJSON(_: SendNotificationResponse): unknown {
    const obj: any = {};
    return obj;
  },
...
function createBaseGetAccessTokensRequest(): GetAccessTokensRequest {
  return { programName: "" };
}

export const GetAccessTokensRequest: MessageFns<GetAccessTokensRequest> = {
  encode(message: GetAccessTokensRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.programName !== "") {
      writer.uint32(10).string(message.programName);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GetAccessTokensRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseGetAccessTokensRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): GetAccessTokensRequest {
    return { programName: isSet(object.programName) ? globalThis.String(object.programName) : "" };
  },

  toJSON(message: GetAccessTokensRequest): unknown {
    const obj: any = {};
    if (message.programName !== "") {
      obj.programName = message.programName;
    }
  ...
  create<I extends Exact<DeepPartial<GetAccessTokensRequest>, I>>(base?: I): GetAccessTokensRequest {
    return GetAccessTokensRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<GetAccessTokensRequest>, I>>(object: I): GetAccessTokensRequest {
    const message = createBaseGetAccessTokensRequest();
    message.programName = object.programName ?? "";
    return message;
  },
...
function createBaseGetAccessTokensResponse(): GetAccessTokensResponse {
  return { tokens: [] };
}

export const GetAccessTokensResponse: MessageFns<GetAccessTokensResponse> = {
  encode(message: GetAccessTokensResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.tokens) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GetAccessTokensResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseGetAccessTokensResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): GetAccessTokensResponse {
    return {
      tokens: globalThis.Array.isArray(object?.tokens) ? object.tokens.map((e: any) => AccessToken.fromJSON(e)) : [],
    };
  },

  toJSON(message: GetAccessTokensResponse): unknown {
    const obj: any = {};
    if (message.tokens?.length) {
  ...
  create<I extends Exact<DeepPartial<GetAccessTokensResponse>, I>>(base?: I): GetAccessTokensResponse {
    return GetAccessTokensResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<GetAccessTokensResponse>, I>>(object: I): GetAccessTokensResponse {
    const message = createBaseGetAccessTokensResponse();
...
export const GenerateAccessTokenRequest: MessageFns<GenerateAccessTokenRequest> = {
  ...
  create<I extends Exact<DeepPartial<GenerateAccessTokenRequest>, I>>(base?: I): GenerateAccessTokenRequest {
    return GenerateAccessTokenRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<GenerateAccessTokenRequest>, I>>(object: I): GenerateAccessTokenRequest {
    const message = createBaseGenerateAccessTokenRequest();
    message.programName = object.programName ?? "";
    message.name = object.name ?? "";
    return message;
...
export const GenerateAccessTokenResponse: MessageFns<GenerateAccessTokenResponse> = {
  encode(message: GenerateAccessTokenResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.token !== undefined) {
      AccessToken.encode(message.token, writer.uint32(10).fork()).join();
    }
    if (message.secret !== "") {
  ...
  fromJSON(object: any): GenerateAccessTokenResponse {
    return {
      token: isSet(object.token) ? AccessToken.fromJSON(object.token) : undefined,
  ...
  create<I extends Exact<DeepPartial<GenerateAccessTokenResponse>, I>>(base?: I): GenerateAccessTokenResponse {
    return GenerateAccessTokenResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<GenerateAccessTokenResponse>, I>>(object: I): GenerateAccessTokenResponse {
    const message = createBaseGenerateAccessTokenResponse();
...
export const DeleteAccessTokenRequest: MessageFns<DeleteAccessTokenRequest> = {
  ...
  fromJSON(object: any): DeleteAccessTokenRequest {
    return {
      programName: isSet(object.programName) ? globalThis.String(object.programName) : "",
      name: isSet(object.name) ? globalThis.String(object.name) : "",
    };
  ...
  toJSON(message: DeleteAccessTokenRequest): unknown {
    const obj: any = {};
    if (message.programName !== "") {
      obj.programName = message.programName;
    }
  ...
  create<I extends Exact<DeepPartial<DeleteAccessTokenRequest>, I>>(base?: I): DeleteAccessTokenRequest {
    return DeleteAccessTokenRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<DeleteAccessTokenRequest>, I>>(object: I): DeleteAccessTokenRequest {
    const message = createBaseDeleteAccessTokenRequest();
    message.programName = object.programName ?? "";
    message.name = object.name ?? "";
    return message;
...
function createBaseDeleteAccessTokenResponse(): DeleteAccessTokenResponse {
  return {};
}

export const DeleteAccessTokenResponse: MessageFns<DeleteAccessTokenResponse> = {
  encode(_: DeleteAccessTokenResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): DeleteAccessTokenResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseDeleteAccessTokenResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
      }
  ...
  fromJSON(_: any): DeleteAccessTokenResponse {
    return {};
  },

  toJSON(_: DeleteAccessTokenResponse): unknown {
    const obj: any = {};
    return obj;
  },

  create<I extends Exact<DeepPartial<DeleteAccessTokenResponse>, I>>(base?: I): DeleteAccessTokenResponse {
    return DeleteAccessTokenResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<DeleteAccessTokenResponse>, I>>(_: I): DeleteAccessTokenResponse {
    const message = createBaseDeleteAccessTokenResponse();
    return message;
  },
};
...
export interface ParticipantCodes {
  ...
  GenerateCode(request: DeepPartial<GenerateCodeRequest>, metadata?: grpc.Metadata): Promise<GenerateCodeResponse>;
...
export class ParticipantCodesClientImpl implements ParticipantCodes {
  ...
  GenerateCode(request: DeepPartial<GenerateCodeRequest>, metadata?: grpc.Metadata): Promise<GenerateCodeResponse> {
    return this.rpc.unary(ParticipantCodesGenerateCodeDesc, GenerateCodeRequest.fromPartial(request), metadata);
  }
...
export const ParticipantCodesGenerateCodeDesc: UnaryMethodDefinitionish = {
  ...
  requestType: {
    serializeBinary() {
      return GenerateCodeRequest.encode(this).finish();
    },
  } as any,
  responseType: {
    deserializeBinary(data: Uint8Array) {
      const value = GenerateCodeResponse.decode(data);
      return {
        ...value,
        toObject() {
          return value;
...
export interface Notifications {
  ...
  UpsertNotification(
    request: DeepPartial<UpsertNotificationRequest>,
    metadata?: grpc.Metadata,
...
export class NotificationsClientImpl implements Notifications {
  ...
  constructor(rpc: Rpc) {
    ...
    this.UpsertNotification = this.UpsertNotification.bind(this);
  ...
  GetNotifications(
    ...
    return this.rpc.unary(NotificationsGetNotificationsDesc, GetNotificationsRequest.fromPartial(request), metadata);
  }
  ...
  GetNotification(
    ...
    return this.rpc.unary(NotificationsGetNotificationDesc, GetNotificationRequest.fromPartial(request), metadata);
  }
  ...
  UpsertNotification(
    ...
    return this.rpc.unary(
      NotificationsUpsertNotificationDesc,
      UpsertNotificationRequest.fromPartial(request),
      metadata,
    );
  }
  ...
  DeleteNotification(
    ...
    return this.rpc.unary(
      NotificationsDeleteNotificationDesc,
      DeleteNotificationRequest.fromPartial(request),
      metadata,
    );
  }
  ...
  SendNotification(
    ...
    return this.rpc.unary(NotificationsSendNotificationDesc, SendNotificationRequest.fromPartial(request), metadata);
  }
}

export const NotificationsDesc = { serviceName: "proto.api.Notifications" };

export const NotificationsGetNotificationsDesc: UnaryMethodDefinitionish = {
...
export const NotificationsGetNotificationDesc: UnaryMethodDefinitionish = {
  ...
  requestType: {
    serializeBinary() {
      return GetNotificationRequest.encode(this).finish();
    },
  } as any,
  responseType: {
    deserializeBinary(data: Uint8Array) {
      const value = GetNotificationResponse.decode(data);
      return {
        ...value,
        toObject() {
          return value;
...
export const NotificationsUpsertNotificationDesc: UnaryMethodDefinitionish = {
  ...
  requestType: {
    serializeBinary() {
      return UpsertNotificationRequest.encode(this).finish();
    },
  } as any,
  responseType: {
    deserializeBinary(data: Uint8Array) {
      const value = UpsertNotificationResponse.decode(data);
      return {
        ...value,
        toObject() {
          return value;
...
export const NotificationsDeleteNotificationDesc: UnaryMethodDefinitionish = {
  ...
  requestType: {
    serializeBinary() {
      return DeleteNotificationRequest.encode(this).finish();
    },
  } as any,
  responseType: {
    deserializeBinary(data: Uint8Array) {
      const value = DeleteNotificationResponse.decode(data);
      return {
        ...value,
        toObject() {
          return value;
...
export const NotificationsSendNotificationDesc: UnaryMethodDefinitionish = {
  ...
  requestType: {
    serializeBinary() {
      return SendNotificationRequest.encode(this).finish();
    },
  } as any,
  responseType: {
    deserializeBinary(data: Uint8Array) {
...
export interface AccessTokens {
  GetAccessTokens(
    request: DeepPartial<GetAccessTokensRequest>,
    metadata?: grpc.Metadata,
  ...
  DeleteAccessToken(
    request: DeepPartial<DeleteAccessTokenRequest>,
    metadata?: grpc.Metadata,
  ): Promise<DeleteAccessTokenResponse>;
}

export class AccessTokensClientImpl implements AccessTokens {
  private readonly rpc: Rpc;
  ...
  GetAccessTokens(
    ...
    return this.rpc.unary(AccessTokensGetAccessTokensDesc, GetAccessTokensRequest.fromPartial(request), metadata);
  }
  ...
  GenerateAccessToken(
    ...
    return this.rpc.unary(
      AccessTokensGenerateAccessTokenDesc,
      GenerateAccessTokenRequest.fromPartial(request),
      metadata,
    );
  }
  ...
  DeleteAccessToken(
    ...
    return this.rpc.unary(AccessTokensDeleteAccessTokenDesc, DeleteAccessTokenRequest.fromPartial(request), metadata);
  }
}

export const AccessTokensDesc = { serviceName: "proto.api.AccessTokens" };

export const AccessTokensGetAccessTokensDesc: UnaryMethodDefinitionish = {
  methodName: "GetAccessTokens",
  service: AccessTokensDesc,
  requestStream: false,
  responseStream: false,
  requestType: {
    serializeBinary() {
      return GetAccessTokensRequest.encode(this).finish();
    },
  } as any,
  responseType: {
    deserializeBinary(data: Uint8Array) {
      const value = GetAccessTokensResponse.decode(data);
      return {
        ...value,
        toObject() {
          return value;
...
export const AccessTokensGenerateAccessTokenDesc: UnaryMethodDefinitionish = {
  ...
  requestType: {
    serializeBinary() {
      return GenerateAccessTokenRequest.encode(this).finish();
    },
  } as any,
  responseType: {
    deserializeBinary(data: Uint8Array) {
      const value = GenerateAccessTokenResponse.decode(data);
      return {
        ...value,
        toObject() {
          return value;
...
export const AccessTokensDeleteAccessTokenDesc: UnaryMethodDefinitionish = {
  ...
  requestType: {
    serializeBinary() {
      return DeleteAccessTokenRequest.encode(this).finish();
    },
  } as any,
  responseType: {
    deserializeBinary(data: Uint8Array) {
      const value = DeleteAccessTokenResponse.decode(data);
      return {
        ...value,
        toObject() {
          return value;
