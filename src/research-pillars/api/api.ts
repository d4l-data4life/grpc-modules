...
export interface Uploads {
  ...
  GetSubjectRawData(
    request: DeepPartial<GetSubjectRawDataRequest>,
    metadata?: grpc.Metadata,
  ): Promise<GetSubjectRawDataResponse>;
  GetSubjectResource(
...
export class UploadsClientImpl implements Uploads {
  ...
  constructor(rpc: Rpc) {
    ...
    this.GetSubjectRawData = this.GetSubjectRawData.bind(this);
  ...
  GetSubjectRawData(
    ...
    return this.rpc.unary(UploadsGetSubjectRawDataDesc, GetSubjectRawDataRequest.fromPartial(request), metadata);
  }
...
export const UploadsGetSubjectRawDataDesc: UnaryMethodDefinitionish = {
  ...
  requestType: {
    serializeBinary() {
      return GetSubjectRawDataRequest.encode(this).finish();
    },
  } as any,
  responseType: {
    deserializeBinary(data: Uint8Array) {
      const value = GetSubjectRawDataResponse.decode(data);
      return {
        ...value,
        toObject() {
          return value;
